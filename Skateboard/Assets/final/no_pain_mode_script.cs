...
public class no_pain_mode_script : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        GUI.Box(new Rect(0, 0, Screen.width*0.2f, Screen.height*0.1f), ((int)score).ToString());
    ...
    void Start()
    {
        ...
        slope = 0f;
        aliable = false;
        lower = new Rect(0f, 0f, Screen.width, Screen.height * 0.6f);
        upper = new Rect(0f, lower.yMax, Screen.width, Screen.height * 0.3f);
    ...
    void Update()
    {
        ...
        else if (touches[Region.Screen].Count == 1)
        {
            ...
            {
                mainCamera.GetComponent<Transform>().RotateAroundLocal(new Vector3(0, 1, 0), -0.5f * Time.deltaTime);
            }
            else
            {
                mainCamera.GetComponent<Transform>().RotateAroundLocal(new Vector3(0, 1, 0), 0.5f * Time.deltaTime);
        ...
        switch (touches[Region.Action].Count)
        {
            ...
            case 0:
                ...
                if (slope != 0f)
                {
                    board_image.transform.RotateAround(new Vector3(0, 0, -1), slope);
                    slope = 0f;
                }
            ...
            case 2:
                ...
                if (skill == 1)
                {
                    if (ali)
                    {
                        ...
                        if (elapsed_time < Action.skill_duration)
                        {
                            ...
                            playable_game_object.transform.Translate(0, 0.2f, 0);
                            action(Action.Ali);
                        }
                        else
                        {
                ...
                {
                    playable_game_object.transform.Rotate(0, -0.4f, 0);
